...
- Add `dmon stack up` for supervised stacks with dependency ordering, readiness probes, attached foreground logs, runtime degradation reporting, optional fail-fast behavior, and automatic cleanup.
